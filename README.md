# FlocksShader
Emergency fix for shader being purged from the Flocks Project.
For some reason, after publishing the "Flocks" plugin, the shader files are completely removed from any downloads. This appears to be an issue on the FAB side. Im in contact to try and have this resolved.
